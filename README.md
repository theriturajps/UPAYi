# [UPIPay](https://upi.gitforge.in)

---

### Show some :heart: and :star: the repo to support the project

[![GitHub stars](https://img.shields.io/github/stars/theriturajps/UPIPay.svg?style=social&label=Star)](https://github.com/theriturajps/UPIPay) ![GitHub followers](https://img.shields.io/github/followers/cyberboysumanjay.svg?style=social&label=Follow)

[![Telegram](https://img.shields.io/badge/Telegram-orange)](https://telegram.dog/riturajps) [![made-with-flask](https://img.shields.io/badge/Made%20with-Flask-1f425f.svg)](https://flask.palletsprojects.com/) ![Hits](https://hits.seeyoufarm.com/api/count/incr/badge.svg?url=https://github.com/theriturajps/UPIPay)
...
<h2><b>Donate</b></h2>
<p style="font-size:20px">
If you wish you can donate to me using my <a href="https://upi.gitforge.in/iamriturajps@oksbi">UPI Link</a> :wink:<br>
...
## [![Deploy](https://button.deta.dev/1/svg)](https://go.deta.dev/deploy?repo=https://github.com/theriturajps/UPIPay)

<h4><a href="https://upi.gitforge.in">Click here to create your UPI link</a></h4>
<h3>Made with :heart: by <a href="https://www.gitforge.in" alt="GitForge">GitForge</a>
</div>
